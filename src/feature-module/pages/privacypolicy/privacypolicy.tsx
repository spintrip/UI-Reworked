...
<p data-aos="fade-down">
  <strong>
    THIS DOCUMENT IS PUBLISHED AND SHALL BE CONSTRUED IN ACCORDANCE WITH THE PROVISIONS OF THE INFORMATION TECHNOLOGY ACT, 2000 AND THE DIGITAL PERSONAL DATA PROTECTION (DPDP) ACT, 2023. THIS POLICY GOVERNS THE COLLECTION, STORAGE, PROCESSING AND TRANSFER OF SENSITIVE PERSONAL DATA OR INFORMATION.
  </strong>
</p>
<p data-aos="fade-down">
  <strong>
    DATA SOVEREIGNTY: ALL USER DATA IS STORED ON SECURE SERVERS LOCATED WITHIN THE TERRITORY OF INDIA. WE DO NOT TRANSFER SENSITIVE PERSONAL DATA OUTSIDE OF THE INDIAN JURISDICTION WITHOUT EXPLICIT REGULATORY COMPLIANCE AS PER DPDP ACT 2023.
  </strong>
</p>
<p data-aos="fade-down">
  <strong>
    PLEASE READ THIS PRIVACY POLICY CAREFULLY. BY USING THE WEBSITE, YOU INDICATE THAT YOU UNDERSTAND, AGREE AND CONSENT TO THIS PRIVACY POLICY. YOU HEREBY PROVIDE YOUR UNCONDITIONAL & IRREVOCABLE CONSENT TO SPINTRIP UNDER THE PROVISIONS OF SECTIONS 43A, 72 AND SECTION 72A OF THE IT ACT AND THE RELEVANT CONSENT PROVISIONS OF THE DPDP ACT 2023.
  </strong>
</p>
